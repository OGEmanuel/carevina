import CareerEmail from '@/app/emails/career';
import CareerReceiptEmail from '@/app/emails/career-thank-you';
...
export async function POST(req: Request) {
  try {
    ...
    if (!fullName || !phone || !email || !position || !resume) {
    ...
    await sendEmail({
      to: email,
      subject: "We've received your application! - Carevina Behavioral Health",
